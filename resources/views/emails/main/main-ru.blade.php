...
<div class="container">
    @if (empty($user))
        <p class="text_align_justify">Здравствуйте!</p>
    @else
        <p class="text_align_justify">Здравствуйте, {{ $user->name }}</p>
    @endif
    ...
    <img alt="Логотип" class="margin_top_10 max_width_logo bold" src="{{asset('storage/for_emails/logo.png')}}">
